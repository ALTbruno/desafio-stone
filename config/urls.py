...
from banco.viewset.conta_viewset import get_saldo, depositar, sacar, transferir, get_extrato, listar_contas, buscar_conta_por_id
...
urlpatterns = [
    ...
    path('contas/', listar_contas),
    path('contas/<int:id_conta>', buscar_conta_por_id),
